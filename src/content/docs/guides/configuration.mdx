...
import { Aside, Tabs, TabItem, Code, Card, CardGrid, Steps } from '@astrojs/starlight/components';
...
<CardGrid>
  ...
  <Card title="Setup Analytics" icon="seti:graph">
    Configure GA4 and GTM with privacy defaults.
    
  [Analytics & Tracking →](/guides/analytics/)
  </Card>
</CardGrid>
